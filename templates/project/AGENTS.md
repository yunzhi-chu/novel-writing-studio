...
- `WRITING_SYSTEM.md`：AI 辅助写作系统规则（滚动梗概承接、禁崩线条款、去 AI 文风十条、对话铁律、雷 1 细则）。写章与评审时全量遵守；与 memory 设定冲突时按梗概>执行档案>范例>人物档案>手稿的优先级取高者。
- `WORLD_START_CARD.md`：世界启动卡（冷启动五步表单）。开新世界 / 新主角时按此流程走，主角必须完全原创，禁止原著人物替身壳。
