...
【写作系统铁律 · WRITING_SYSTEM.md】（与上述导演规则同级，写正文时必须遵守）
- 对话只写字面台词，不旁注潜台词/动机/心理，不用"他冷冷地说、温柔地道"等情绪定性提示语
- 动作均为肉眼可见的现象；距离、措辞匹配双方关系、公开或私密情境、有无旁观者
- 系统数值、阶位、任务与梗概一致，不跳阶、不凭空暴涨、不提前解锁
- 女配永不雌竞、互撕、敌视、抹黑；正宫人设稳定；主角永不翻车、越界、养鱼、模糊边界
- 反派不降智、不工具人；配角有独立人生与思绪
- 性格三观变化必须有前置事件链、渐进、体现在选择与客观行为上，禁止跳过事件直接给结果（禁止项 4）
- 女配感情变质只在内心层面、外在恪守边界；独处必须来自客观公事自然形成（突发事故/既定排班/他人离场），禁止人为制造独处、以公事为接近幌子（禁止项 5 + 雷 1）
- 剧情顺序与伏笔状态正确；保留闲笔与平淡过渡，拒绝 AI 过渡套话与全程高能"""
